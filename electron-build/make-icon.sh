...
mkdir -p MBABrowser.iconset

sips -z 16 16     icon_1024.png --out MBABrowser.iconset/icon_16x16.png
sips -z 32 32     icon_1024.png --out MBABrowser.iconset/icon_16x16@2x.png
sips -z 32 32     icon_1024.png --out MBABrowser.iconset/icon_32x32.png
sips -z 64 64     icon_1024.png --out MBABrowser.iconset/icon_32x32@2x.png
sips -z 128 128   icon_1024.png --out MBABrowser.iconset/icon_128x128.png
sips -z 256 256   icon_1024.png --out MBABrowser.iconset/icon_128x128@2x.png
sips -z 256 256   icon_1024.png --out MBABrowser.iconset/icon_256x256.png
sips -z 512 512   icon_1024.png --out MBABrowser.iconset/icon_256x256@2x.png
sips -z 512 512   icon_1024.png --out MBABrowser.iconset/icon_512x512.png
cp icon_1024.png                    MBABrowser.iconset/icon_512x512@2x.png

echo "Собираю .icns..."
iconutil -c icns MBABrowser.iconset -o icon.icns
...
rm -rf MBABrowser.iconset icon_source.jpg icon_1024.png
